...
from swarm_test import (BallSource, MAX_AREA, MIN_AREA, RunLog, V_MIN, Path,
...
def test_zeroing_happens_at_rest_and_measures_nothing():
    ...
    import swarm_test as blob_test
...
def test_advice_scales_with_speed():
    ...
    must go slower."""
    from swarm_test import latency_advice
...
def test_the_probe_names_which_axis_is_inverted():
    ...
    from swarm_test import BlobTest
